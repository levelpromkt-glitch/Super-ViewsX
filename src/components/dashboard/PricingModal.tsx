...
export function PricingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[80vh] my-auto overflow-hidden bg-[#0a0a0b] rounded-3xl border border-white/10 shadow-2xl">
        <button
          onClick={onClose}
        ...
        <div className="overflow-y-auto w-full max-h-[80vh] p-6 flex flex-col justify-center custom-scrollbar">
