...
import { ArrowUpRight, Trophy, TrendingUp, Flame, Settings, Sparkles, Link2, Send } from "lucide-react";
...
const items = [
  ...
  { to: "/dashboard/publicar", label: "Publicar", icon: Send, exact: false, adminOnly: false, pro: false },
